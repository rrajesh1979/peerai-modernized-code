 ...
 * Configures MongoDB client, connection settings, repositories, and auditing.
 */
@Configuration
...
public class MongoConfig extends AbstractMongoClientConfiguration {
    ...
    /**
     * Customizes the MongoTemplate to ensure proper handling of MongoDB documents
     */
    @Bean
    public MongoTemplate mongoTemplate() throws Exception {
        MongoTemplate mongoTemplate = new MongoTemplate(mongoClient(), getDatabaseName());
        
        // Configure the mapping converter to handle dots in field names
