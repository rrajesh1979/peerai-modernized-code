...
public interface TaskRepository extends MongoRepository<Task, String> {
     ...
     */
    List<Task> findByDueDateBeforeAndStatusNot(LocalDateTime currentDate, String status);
    ...
    List<Task> searchByTitleOrDescription(String searchTerm);
     ...
     * @param projectId the project identifier
     * @param status the task status
     * @return count of tasks matching the criteria
     */
    ...
    /**
     * Find tasks that have tags containing the specified tag
     * 
